...
namespace Gicc
{
	public class Pull
	{
		public static void Execute(DateTime since, DateTime until)
		{
		...
		internal static void CheckCheckedOutFileIsNotExist()
		{
		...
		internal static void CheckAllSymbolicLinksAreMounted()
		{
